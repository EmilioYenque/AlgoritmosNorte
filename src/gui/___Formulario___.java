...
public class ___Formulario___ extends JFrame implements ActionListener {
	...
	imprimir("Precio menor al minimo:"+a.buscarUltPrecMenorMin());
	imprimir("Precio mayor al minimo:"+a.buscarUltPrecMayMin());
	imprimir("Mayores al promedio:"+a.mayorPromedio());
	imprimir("Menor al promedio"+a.menorPromedio());
	}
}